...
public class KakaoService {
	...
	public String getAccessToken(String code) {
		...
		try {
			...
			sb.append("&client_id=6e60d29aeee08f774aad976e5ff643f9");
			...
			System.out.println("response body11111111111111111="+result);
	...
	public HashMap<String, Object> getUserInfo(String accessToken) {
		...
		try {
			...
			System.out.println("response body222222222222222222 ="+result);
