...
public class LogBackConfig {
    ...
    private void createLoggers() {
        ...
        createLogger("com.cloneproject.ssgjojo", INFO, false);
        createLogger("com.cloneproject.ssgjojo.*.controller", DEBUG, false);
        createLogger("com.cloneproject.ssgjojo.*.service", WARN, false);
        createLogger("com.cloneproject.ssgjojo.*.repository", INFO, false);
    }
